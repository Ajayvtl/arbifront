...
import { Loader2, Plus, Save, Settings2, Rocket, PencilLine, Trash2 } from "lucide-react";
    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-6">
      ...
      <form onSubmit={submitRule} className="rounded-2xl border border-slate-200 bg-slate-50/50 p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-12 lg:col-span-4 flex items-end justify-between lg:justify-end gap-3 h-full pt-4 lg:pt-0 mt-2">
             <button
                type="button"
